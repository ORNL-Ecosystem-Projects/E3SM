...
#include "shr_assert.h"
  ...
  use elm_varctl         , only : iulog, use_cn, use_lch4, use_microbe_methane, &
       use_legacy_ch4_with_microbe, use_fates
...
contains
  ...
  subroutine Init( this, bounds, cellorg_col )
    ...
    if (use_lch4) then
        ...
        if (.not. use_microbe_methane .or. use_legacy_ch4_with_microbe) &
