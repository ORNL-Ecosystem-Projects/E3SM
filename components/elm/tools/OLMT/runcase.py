...
if (options.mod_parm_file != ''):
    ...
    if (options.humhol):
      ...
      print('qflx_h2osfc_surfrate = 8.9192395533995e-8')
      ...
      os.system('ncap -O -s "qflx_h2osfc_surfrate = br_mr*0+8.9192395533995e-8" '+tmpdir+'/clm_params.nc '+tmpdir+'/clm_params.nc')
