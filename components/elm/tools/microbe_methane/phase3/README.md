# Phase 3 Step 1 state and parameter tests

This directory verifies the revised-methane parameter/state foundation. It
supplements CIME; it does not replace ELM build, run, or exact-restart tests.
